...
import { useBottomSheetStack } from '@/shared/ui/templates/bottom-sheet-stack';
...
function AmountPickerSheetContent() {
  ...
  return (
    <View style={{ backgroundColor: colors.surface, paddingTop: 4, gap: 18 }}>
...
/** Sheet to present via useBottomSheet().present(<AmountPickerSheet />) */
